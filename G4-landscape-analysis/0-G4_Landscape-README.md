...
- **📁 Directory: Further analysis steps** *Contains several custom scripts used for distinct downstream analyses associated with potential G4-forming regions, including TFBS density in pG4s, CGGBP1 divergence rates, phylogeny independent contrasts (PIC), and mutation rate calculations.*
