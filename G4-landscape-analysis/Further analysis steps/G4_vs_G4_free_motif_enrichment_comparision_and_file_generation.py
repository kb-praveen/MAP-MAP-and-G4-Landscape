...
# --- CONFIGURATION ---
CORES = 48
G4_RAW_COUNTS = Path('Path//G4_motif_analysis/Fimo_in_G4s_genomewide/Motif_counts_in_G4_regions_genomewide_in_vertebrates.tsv')
BG_RAW_COUNTS = Path('Path//G4_motif_analysis/Fimo_G4_free_background/Motif_counts_in_G4_free_regions_equivalent_genomewide_in_vertebrates.tsv')

METADATA_FILE = Path('Path//G4_motif_analysis/Table_S1.tsv')
OUTPUT_DIR = Path('Path//G4_motif_analysis/Statistical_Analysis')
