...
input_file <- "Path/GC_rich_TFBS_mutation_profile_genome_wide/final_CtoT_fraction_subtracted.xlsx"  # Path to input data file
output_file_with_col_dend <- "Path/GC_rich_TFBS_mutation_profile_genome_wide/CtoT_fraction_heatmap_with_col_dend.png"  # Output file: heatmap with both dendrograms
output_file_without_col_dend <- "Path/GC_rich_TFBS_mutation_profile_genome_wide/CtoT_fraction_heatmap_without_col_dend.png"  # Output file: heatmap with only row dendrogram
