...
# F [🔄 STEP6: Reverse complementing the reads falling on to minus (-) strand after paired end alignment from raw FASTQ file (Mate1/Mate2) - Bash script]
...
**STEP6:** Reverse complementing the reads falling on minus (-) strand after paired end alignment from raw FASTQ file (Mate1/Mate2) - Bash script  
...
**STEP10:** SAM file comparison (Paired end vs single end) to make sure alignment occurred correctly - Bash script  
...
**STEP18:** Script for handling Duplicate entries occurred due to chunk process - Python script  
