...
RESULTS_DIR = Path('/scratch/kumarpraveen/G4_motif_analysis/Results')
ENTIRE_PROM_FASTA = Path('/scratch/kumarpraveen/G4_motif_analysis/Entire_promoter_fasta')
G4_PROM_FASTA = Path('/scratch/kumarpraveen/G4_motif_analysis/Promoter_G4_fasta')

JOBS = [
    {
        "name": "G4_free_promoter",
        "input_dir": Path('/scratch/kumarpraveen/G4_motif_analysis/Fimo_on_G4_free_promoters'),
        "count_file": "Motif_counts_in_G4_free_promoters_raw.tsv"
    },
    {
        "name": "G4_in_promoter",
        "input_dir": Path('/scratch/kumarpraveen/G4_motif_analysis/G4_in_promoters'),
...
base <- "/scratch/kumarpraveen/G4_motif_analysis"
