...
# Input paths
G4_COUNTS_FILE = Path('/scratch/kumarpraveen/G4_motif_analysis/Fimo_in_G4s_genomewide/Motif_counts_in_G4_regions_genomewide_in_vertebrates.tsv')
BG_COUNTS_FILE = Path('/scratch/kumarpraveen/G4_motif_analysis/Fimo_G4_free_background/Motif_counts_in_G4_free_regions_equivalent_genomewide_in_vertebrates.tsv')

# Output directories
RESULTS_BASE = Path('/scratch/kumarpraveen/G4_motif_analysis/Results')
